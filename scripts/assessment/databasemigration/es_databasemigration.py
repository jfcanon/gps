"""ES checks for Azure Database Migration Service (MCSB v3). Transient migration service — all UNKNOWN."""


def _u(n, c, f, u): return {"resource": n or "all", "control_id": c, "feature": f, "status": "UNKNOWN",
                              "actual_value": "DMS is a managed migration service — no persistent customer compute on DMS ARM resource", "expected_value": "N/A", "evidence_url": u}
