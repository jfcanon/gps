#!/usr/bin/env python3
"""
Azure Key Vault — Compliance Assessment Runner (V2)
...
def main():
    parser = argparse.ArgumentParser(
        description="Run MCSB v3 compliance checks for Azure Key Vault (v2)"
    )
    ...
    out_file = os.path.join(args.output_dir, f"keyvault_v2_{args.subscription_id}_{timestamp}.json")
