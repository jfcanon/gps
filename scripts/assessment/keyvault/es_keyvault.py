"""
Endpoint Security checks for Azure Key Vault.
...
deployed by customers. Microsoft manages the underlying infrastructure internally.
"""
from typing import Callable


def _paas_not_applicable(vault_name: str | None, control_id: str, feature: str, evidence_url: str) -> dict:
    return {
...
def check_es2_antimalware(credential, subscription_id: str, resource_group: str | None, vault_name: str | None) -> dict:
    return _paas_not_applicable(
        vault_name, "ES-2", "Anti-Malware Solution",
        "https://learn.microsoft.com/en-us/azure/key-vault/general/overview"
    )
...
def check_es3_antimalware_health(credential, subscription_id: str, resource_group: str | None, vault_name: str | None) -> dict:
    return _paas_not_applicable(
        vault_name, "ES-3", "Anti-Malware Solution Health Monitoring",
        "https://learn.microsoft.com/en-us/azure/key-vault/general/overview"
    )
