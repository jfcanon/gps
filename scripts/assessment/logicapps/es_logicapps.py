"""ES checks for Azure Logic Apps (MCSB v3). PaaS — all UNKNOWN."""


def _u(n, c, f, u): return {"resource": n or "all", "control_id": c, "feature": f, "status": "UNKNOWN",
                              "actual_value": "PaaS orchestration service — no customer compute on workflow ARM resource", "expected_value": "N/A", "evidence_url": u}
