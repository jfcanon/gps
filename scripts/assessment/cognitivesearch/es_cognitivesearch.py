"""Endpoint Security — Azure Cognitive Search (MCSB v3). PaaS — all UNKNOWN."""


def _u(n, c, f, u): return {"resource": n or "all", "control_id": c, "feature": f, "status": "UNKNOWN",
                              "actual_value": "PaaS search service — no customer compute", "expected_value": "N/A", "evidence_url": u}
