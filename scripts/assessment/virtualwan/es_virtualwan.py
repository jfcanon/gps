"""ES checks for Azure Virtual WAN (MCSB v3). Infrastructure service — all UNKNOWN."""


def _u(n, c, f, u): return {"resource": n or "all", "control_id": c, "feature": f, "status": "UNKNOWN",
                              "actual_value": "Infrastructure networking service — no customer compute on WAN resource", "expected_value": "N/A", "evidence_url": u}
