"""PV checks for Azure Data Factory (MCSB v3). PaaS factory resource — all UNKNOWN."""


def _u(n, c, f, u): return {"resource": n or "all", "control_id": c, "feature": f, "status": "UNKNOWN",
                              "actual_value": "PaaS service — Microsoft manages ADF infrastructure",
                              "expected_value": "N/A", "evidence_url": u}
