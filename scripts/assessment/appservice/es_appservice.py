"""
Endpoint Security checks for Azure App Service (MCSB v3).
...
def _paas_na(site_name, control_id, feature, url):
    return {
        ...
        "feature": feature,
        "status": "UNKNOWN",
        "actual_value": "PaaS service — no customer-accessible compute layer; endpoint security agents cannot be deployed on App Service infrastructure",
        "expected_value": "N/A",
        "evidence_url": url,
    }
