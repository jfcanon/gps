"""
Posture and Vulnerability Management checks for Azure App Service (MCSB v3).
...
def _paas_na(site_name, control_id, feature, url):
    return {
        ...
        "feature": feature,
        "status": "UNKNOWN",
        "actual_value": "PaaS service — Microsoft manages App Service infrastructure, OS, and runtime; control not applicable to customer workloads",
        "expected_value": "N/A",
        "evidence_url": url,
    }
...
def check_pv3_custom_vm_images(credential, subscription_id, resource_group, site_name):
    return _paas_na(site_name, "PV-3", "Custom VM Images",
